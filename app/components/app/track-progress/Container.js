...
const TrackProgressContainer = props => {
  ...
  const [fetching_quiz_progress_data, set_Fetching_Quiz_Progress_Data] =
    useState(false);
  const [
    fetching_quiz_data_progress_error,
    set_Fetching_Quiz_Data_Progress_Error,
  ] = useState(false);
  ...
  useEffect(() => {
    if (props.route.params.selected_child_account !== undefined) {
      console.log(
        'props.route.params.selected_child_account: ',
        props.route.params.selected_child_account,
      );
  ...
  useEffect(() => {
    console.log(
      'selected_screen and quiz_progress_data updated in UE',
      selected_screen,
      quiz_progress_data,
    );
    console.log(
      'fetching_quiz_progress_data and fetching_quiz_progress_data_error Error updated in UE',
  ...
  // fetch all the attempted quizs of current child
  ...
  return (
    <TrackProgressComponent
      ...
      fetching_quiz_progress_data={fetching_quiz_progress_data}
      fetching_quiz_data_progress_error={fetching_quiz_data_progress_error}
