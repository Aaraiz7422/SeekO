        ...
        <View style={[global.auth_container, {
            ...
            <View style={[global.row_flex_end_container, { width: Dimensions.get('window').width * 1 }]}>
                <Button
                    ...
                    <Text style={{ color:'black', fontSize: 16,fontFamily:'Poppins-Regular', }}>Sign Up</Text>
                </Button>
            </View>
            <Image
                source={require('../../../assets/Logo.png')}
            ></Image>
            <Text style={{ margin: 30,color:'black', fontSize: 26, fontWeight: '700',fontFamily:'Poppins-Regular', }}>Sign In</Text>
            <View>
                <TextInput
            ...
            <View style={[global.row_flex_end_container, { width: Dimensions.get('window').width * 0.7 }]}>
                <Text
                    style={[global.anchor_text,{fontFamily:'Poppins-Regular',color:'black',}]}
